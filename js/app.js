(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                ...
                document.addEventListener("click", (function(e) {
                    if (e.target.closest(".form__input")) document.documentElement.classList.toggle("input-open"); else if (!e.target.closest(".form__input")) functions_menuClose();
                }));
        ...
        function functions_menuClose() {
            ...
            document.documentElement.classList.remove("input-open");
        }
        function showMore() {
                ...
                function getHeight(showMoreBlock, showMoreContent) {
                    ...
                    if (showMoreType === "items") {
                        ...
                        for (let index = 1; index < showMoreItems.length; index++) {
                            ...
                            let heightPlus = 10;
                            hiddenHeight += showMoreItem.offsetHeight + marginTop + heightPlus;
